...
public final class BluetoothUtil {
	 ...
	 *            application context
	 * @param time
	 *            number of seconds to be discoverable
	 * @param act
	 *            callback to be executed afterwards.
	 */
	...
	/**
	 * Receiver for fetching callbacks. Should be called in Activities
	 * onActivityResult in the beginning.
	 * 
	 * @param context
	 *            current activity context
	 * @param reqCode
	 *            the results request code
	 * @param resultCode
	 *            the result code
	 * @param data
